...
def test_first_key():
    path = split_path('key', '.', escape_type.NO_ESCAPE, False)
    assert path == ['key']


def test_simple_merge():
    path = split_path('path.key', '.', escape_type.NO_ESCAPE, False)
    assert path == ['path', 'key']


# def test_escape_double_single_char():
#     path = split_path('..', '.', escape_type.DOUBLE, False)
#     assert path == ['.']
#
#
# def test_escape_double_start_one():
#     path = split_path('..a', '.', escape_type.DOUBLE)
#     assert path == ['.a']
