...
namespace pyorderedjson {
    ...
    inline nl::ordered_json to_json(const py::handle &obj) {
        ...
        if (py::isinstance<py::int_>(obj)) {
            try {
                auto s = obj.cast<nl::ordered_json::number_integer_t>();
                if (py::int_(s).equal(obj)) {
                    return s;
                }
            }
            ...
            try {
                auto u = obj.cast<nl::ordered_json::number_unsigned_t>();
                if (py::int_(u).equal(obj)) {
                    return u;
                }
            }
            ...
            throw std::runtime_error(
                    "to_json received an integer out of range for both nl::ordered_json::number_integer_t and nl::ordered_json::number_unsigned_t type: " +
                    py::repr(obj).cast<std::string>());
        }
        if (py::isinstance<py::float_>(obj)) {
            return obj.cast<double>();
...
namespace pybind11::detail {
        ...
        PYBIND11_TYPE_CASTER(nl::json, _("json"));
            ...
            static handle cast(const nl::json& src, return_value_policy /* policy */, handle /* parent */) {
